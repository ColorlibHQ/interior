...
class interior_social_widget extends WP_Widget {
...
'interior_social_widget',


// Widget name will appear in UI
esc_html__( '[ Interior ] Social Widget', 'interior-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'interior-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'interior-companion' );
}
...
} // Class interior_social_widget ends here


// Register and load the widget
function interior_social_load_widget() {
	register_widget( 'interior_social_widget' );
}
add_action( 'widgets_init', 'interior_social_load_widget' );