...
class Interior_Clients extends Widget_Base {

	public function get_name() {
		return 'interior-clients';
	}

	public function get_title() {
		return __( 'Clients', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'clients_content',
			[
				'label' => __( 'Clients', 'interior-companion' ),
			]
		);
		$this->add_control(
            'clients', [
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Client Url', 'interior-companion' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => '#'
                    ],
                    [
                        'name'  => 'img',
                        'label' => __( 'Client Logo', 'interior-companion' ),
