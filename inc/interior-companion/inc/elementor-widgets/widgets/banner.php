...
/**
 *
 * Interior elementor about us section widget.
 *
 * @since 1.0
 */
class Interior_Banner extends Widget_Base {
	...
	public function get_title() {
		return __( 'Banner', 'interior-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_content',
            [
                'label' => __( 'Banner Section Content', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'banner_titleone',
            [
                ...
                'default'       => esc_html__( 'Support Our Party', 'interior-companion' ),
                'label_block'   => true
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'       => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim. sed do eiusmod tempor incididunt.', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'banner_btnlabel',
            [
                ...
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'View Details', 'interior-companion' )
            ]
        );
        $this->add_control(
            'banner_btnurl',
        ...
        $this->add_control(
            'color_titleone', [
                'label'     => __( 'Title #1 Color', 'interior-companion' ),
        ...
        $this->add_control(
            'color_btnlabel', [
                'label'     => __( 'Button Label Color', 'interior-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhoverlabel', [
                'label'     => __( 'Button Hover Label Color', 'interior-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnborder', [
                'label'     => __( 'Button Border Color', 'interior-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhovborder', [
                'label'     => __( 'Button Hover Border Color', 'interior-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnbg', [
                'label'       => __( 'Button Background Color', 'interior-companion' ),
                'type'        => Controls_Manager::COLOR,
                'default'     => '#c6b069',
                'selectors'   => [
        ...
        $this->add_control(
            'color_btnhovbg', [
                'label'     => __( 'Button Hover Background Color', 'interior-companion' ),
                'type'      => Controls_Manager::COLOR,
            ...
            <div class="row fullscreen d-flex align-items-center justify-content-center">
                <div class="banner-content col-lg-12 col-md-12">
                    ...
                    if( ! empty( $settings['banner_desc'] ) ) {
                            echo interior_get_textareahtml_output( $settings['banner_desc'] );
                    }
                    // Button
