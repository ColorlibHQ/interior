...
class interior_theme_customizer {
    ...
    public function interior_theme_customizer_options( $wp_customize ) {
        ...
        $wp_customize->get_section( 'title_tagline' )->panel = 'interior_options_panel';
        // Change colors panel to theme option
        $wp_customize->get_section( 'colors' )->panel = 'interior_options_panel';
        // change priorities
		...
		$wp_customize->get_section('colors')->title = esc_html__( 'Page Header', 'interior' );
		// Rename customizer background image section
        $wp_customize->get_section('background_image')->title = esc_html__( 'Background', 'interior' );
        ...
        $wp_customize->selective_refresh->add_partial( 'interior-blog-like-toggle', 
        array( 'selector' => '.sl-wrapper' ) );
        // Post Share button selective refresh
        $wp_customize->selective_refresh->add_partial( 'interior-blog-social-share-toggle', 
    ...
    public function interior_customizer_js() {
        ...
        wp_localize_script( 'interior-customizer', 'interiorCustomizerdata', array(
            'site_url'      => site_url('/'),
