...
class Interior_Enqueue {

	public $scripts = array();

	public function interior_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'interior_frontend_enqueue_scripts', ) );
	}

	public function interior_frontend_enqueue_scripts( ) {
