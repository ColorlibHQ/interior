...
// image default alt
if( ! function_exists( 'interior_img_default_alt' ) ) {
	function interior_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'interior_img_tag' ) ) {
	function interior_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = interior_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'interior_anchor_tag' ) ) {
	function interior_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'interior' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'interior_heading_tag' ) ) {
	function interior_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'interior' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'interior_paragraph_tag' ) ) {
	function interior_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'interior_other_tag' ) ) {
	function interior_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'interior_button_element ' ) ) {
	function interior_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'interior' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
